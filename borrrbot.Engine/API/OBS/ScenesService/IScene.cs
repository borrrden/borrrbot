...
{
    /// <summary>
    /// An interface representing a read-only scene in OBS
    /// </summary>
    public interface IScene
    {
        ...
        /// <summary>
        /// Gets the ID of the scene for use with other
        /// RPC methods
        /// </summary>
        string id { get; }
        ...
        /// <summary>
        /// Gets a list of the nodes present inside of the scene
        /// </summary>
        IReadOnlyList<ISceneItemNode> nodes { get; }
